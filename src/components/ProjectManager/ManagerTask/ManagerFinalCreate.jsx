...
import "../../Style/ProjectManager/ManagerFinalCreate.css"; // <-- hiwalay na CSS file
...
const ManagerFinalCreate = ({ onClose, onCreate, taskToEdit, onUpdate }) => {
      ...
      <form className="modal-container" onSubmit={handleSubmit} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="form-grid">
                ...
                {!formData.taskCategory ? (
                  ...
                  <>
                    <div className="dropdown-header">
                      ...
                      <span className="clear-task-category" onClick={clearTaskCategory}>
                        ⓧ
                      </span>
                    </div>
          ...
          <div className="form-field">
            ...
            <input type="date" id="dueDate" value={formData.dueDate} onChange={handleInputChange("dueDate")} />
          </div>

          {/* Time */}
          <div className="form-field time-field">
            <label htmlFor="time">Time</label>
            <input type="time" id="time" value={formData.time} onChange={handleInputChange("time")} />
          </div>
          ...
          <div className="assigned-box-wrapper">
            ...
            <div className="assigned-list">
              {formData.assigned.map((name) => (
                <div key={name} className="assigned-chip">
...
export default ManagerFinalCreate;
