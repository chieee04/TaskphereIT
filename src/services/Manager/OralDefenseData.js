// oralDefenseData.js
// ==================
// Full Oral Defense data (Agile + Prototyping + RAD + Spiral + XP)

export const oralDefenseData = {
  // ================== Agile ==================
  Agile: {
    projectPhase: "Design",
    Documentation: {
  ...
  Prototyping: {
    ...
    Documentation: {
      ...
      "Refinement of UI & Functionalities": {},
